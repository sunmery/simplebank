...
argocd proj add-source simplebank https://github.com/sunmery/simplebank.git
...
argocd proj add-destination simplebank https://116.213.43.175:6443 simplebank
...
--dest-server https://116.213.43.175:6443 \
--dest-namespace bank \
--validate
